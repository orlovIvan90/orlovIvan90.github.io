...
BX.showWait = function(node, msg)
{
	...
	var obMsg = node.bxmsg = document.body.appendChild(BX.create('DIV', {
		...
		style: {
			background: 'url("images/wait.gif"/*tpa=http://www.avgust.com/bitrix/js/main/core/images/wait.gif*/) no-repeat scroll 10px center #fcf7d1',
	...
	if (type == "icon")
	{
		element = BX.create('IMG', {
			props: {
				src: params.iconSrc
					? params.iconSrc
					: "images/hint.gif"/*tpa=http://www.avgust.com/bitrix/js/main/core/images/hint.gif*/
			}
		});
	}
	else if (type == "link")
