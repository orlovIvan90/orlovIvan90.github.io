...
(function($) {
    $(document).ready(function() {
        ...
        function makeControllerAnimations() {
            ...
            /* numbers animation */
            var do__green1 = TweenMax.to("#do__green1", 1, { opacity: 1, y: "-100", ease: Linear.easeNone});

            var scene1 = new ScrollMagic.Scene({triggerHook: "onEnter", triggerElement:"#do__green1-trigger", duration: "30%"}).setTween(do__green1).addTo(controller);
