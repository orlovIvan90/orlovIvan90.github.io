...
(function($) {
    $(document).ready(function() {
        ...
        function makeControllerAnimations() {
            ...
            /* -------------- */
            /* presentation */
            var site__img1 = TweenMax.to("#site__img1", 1, { opacity: 1, left: "11.7%", width: "21.6%", ease: Linear.easeNone});
            ...
            var site__img2 = TweenMax.to("#site__img2", 1, { opacity: 1, top: "120px", width: "24.3%", ease: Linear.easeNone});

            var scene2 = new ScrollMagic.Scene({triggerHook: "onEnter", triggerElement:"#site__img-trigger", duration: "70%"}).setTween(site__img2).addTo(controller);


            var site__img3 = TweenMax.to("#site__img3", 1, { opacity: 1, top: "180px", width: "30.7%", left: "44%", ease: Linear.easeNone});

            var scene3 = new ScrollMagic.Scene({triggerHook: "onEnter", triggerElement:"#site__img-trigger", duration: "70%"}).setTween(site__img3).addTo(controller);


            var site__img4 = TweenMax.to("#site__img4", 1, { opacity: 1, left: "69.7%", ease: Linear.easeNone});

            var scene4 = new ScrollMagic.Scene({triggerHook: "onEnter", triggerElement:"#site__img-trigger", duration: "70%"}).setTween(site__img4).addTo(controller);

            
            var site__img5 = TweenMax.to("#site__img5", 1, { opacity: 1, width: "35.7%", marginLeft: "-38%", ease: Linear.easeNone});
            ...
            var site__img6 = TweenMax.to("#site__img6", 1, { opacity: 1, width: "35.7%", marginLeft: "2.3%", ease: Linear.easeNone});
            ...
            var site__img7 = TweenMax.to("#site__img7", 1, { opacity: 1, width: "84.3%", marginLeft: "-42.2%", ease: Linear.easeNone});

            var scene7 = new ScrollMagic.Scene({triggerHook: "onEnter", triggerElement:"#site__img-trigger3", duration: "70%"}).setTween(site__img7).addTo(controller);
