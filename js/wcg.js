...
(function($) {
    $(document).ready(function() {
        ...
        function makeControllerAnimations() {
            ...
            /* presentation */
            var site__img1 = TweenMax.to("#site__img1", 1, { opacity: 1, width: "46%", ease: Linear.easeNone});

            var scene1 = new ScrollMagic.Scene({triggerHook: "onEnter", triggerElement:"#site__img-trigger", duration: "60%"}).setTween(site__img1).addTo(controller);
