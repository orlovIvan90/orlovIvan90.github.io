...
(function($) {
    $(document).ready(function() {
        ...
        function makeControllerAnimations() {
            ...
            /* presentation */
            var site__img1 = TweenMax.to("#site__img1", 1, { opacity: 1, y: "127", ease: Linear.easeNone});

            var scene1 = new ScrollMagic.Scene({triggerHook: "onEnter", triggerElement:"#site__img-trigger", duration: "80%"}).setTween(site__img1).addTo(controller);


            var site__img2 = TweenMax.to("#site__img2", 1, { opacity: 1, y: "-186", left: "8.2%", ease: Linear.easeNone});
            ...
            var site__img3 = TweenMax.to("#site__img3", 1, { opacity: 1, y: "-151", left: "42%", ease: Linear.easeNone});

            var scene3 = new ScrollMagic.Scene({triggerHook: "onEnter", triggerElement:"#site__img-trigger", duration: "80%"}).setTween(site__img3).addTo(controller);


            var site__img4 = TweenMax.to("#site__img4", 1, { opacity: 1, left: "71.2%", ease: Linear.easeNone});

            var scene4 = new ScrollMagic.Scene({triggerHook: "onEnter", triggerElement:"#site__img-trigger", duration: "80%"}).setTween(site__img4).addTo(controller);


            var site__img5 = TweenMax.to("#site__img5", 1, { opacity: 1, width: "64.8%", ease: Linear.easeNone});
