...
(function($) {
    $(document).ready(function() {
        ...
        function makeControllerAnimations() {
            ...
            var site__img1 = TweenMax.to("#site__wrap-img-1", 1, { opacity: 1, width: "61%", ease: Linear.easeNone});
        
            var scene1 = new ScrollMagic.Scene({triggerHook: "onEnter", triggerElement:"#site__wrap-img-1-trigger", duration: "40%"}).setTween(site__img1).addTo(controller);


            var site__img2 = TweenMax.to("#site__wrap-img-2", 1, { opacity: 1, width: "61%", ease: Linear.easeNone});

            var scene2 = new ScrollMagic.Scene({triggerHook: "onEnter", triggerElement:"#site__wrap-img-2-trigger", duration: "40%"}).setTween(site__img2).addTo(controller);


            var site__img3 = TweenMax.to("#site__wrap-img-3", 1, { opacity: 1, width: "61%", ease: Linear.easeNone});

            var scene3 = new ScrollMagic.Scene({triggerHook: "onEnter", triggerElement:"#site__wrap-img-3-trigger", duration: "40%"}).setTween(site__img3).addTo(controller);


            var site__img4 = TweenMax.to("#site__wrap-img-4", 1, { opacity: 1, width: "61%", ease: Linear.easeNone});

            var scene4 = new ScrollMagic.Scene({triggerHook: "onEnter", triggerElement:"#site__wrap-img-4-trigger", duration: "40%"}).setTween(site__img4).addTo(controller);


            var site__img5 = TweenMax.to("#site__wrap-img-5", 1, { opacity: 1, width: "61%", ease: Linear.easeNone});

            var scene5 = new ScrollMagic.Scene({triggerHook: "onEnter", triggerElement:"#site__wrap-img-5-trigger", duration: "40%"}).setTween(site__img5).addTo(controller);


            var site__img6 = TweenMax.to("#site__wrap-img-6", 1, { opacity: 1, width: "61%", ease: Linear.easeNone});

            var scene5 = new ScrollMagic.Scene({triggerHook: "onEnter", triggerElement:"#site__wrap-img-6-trigger", duration: "40%"}).setTween(site__img6).addTo(controller);
