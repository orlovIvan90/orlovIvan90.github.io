...
//            /* presentation */
            var site__img1 = TweenMax.to("#site__img1", 1, { opacity: 1, width: "58%", ease: Linear.easeNone});

            var scene1 = new ScrollMagic.Scene({triggerHook: "onEnter", triggerElement:"#site__img-trigger", duration: "30%"}).setTween(site__img1).addTo(controller);


            var site__img2 = TweenMax.to("#site__img2", 1, { opacity: 1, width: "45.4%", marginLeft: "-32.5%", ease: Linear.easeNone});

            var scene2 = new ScrollMagic.Scene({triggerHook: "onEnter", triggerElement:"#site__img-trigger2", duration: "70%"}).setTween(site__img2).addTo(controller);


            var site__img3 = TweenMax.to("#site__img3", 1, { opacity: 1, width: "26.3%", marginRight: "-34.2%", ease: Linear.easeNone});

            var scene3 = new ScrollMagic.Scene({triggerHook: "onEnter", triggerElement:"#site__img-trigger2", duration: "70%"}).setTween(site__img3).addTo(controller);


            var site__img4 = TweenMax.to("#site__img4", 1, { opacity: 1, bottom: "48px", ease: Linear.easeNone});
